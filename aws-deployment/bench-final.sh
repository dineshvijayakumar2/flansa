...
echo "🚀 Starting Frappe + Flansa (Final Working Version)"
echo "=================================================="
...
# Use bench start for development or simple serve for production
# bench serve without parameters runs on 8000 by default
exec bench serve