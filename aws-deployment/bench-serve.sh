...
echo "🚀 Starting Frappe + Flansa with bench serve (Production Ready)"
echo "============================================================="

PORT=${PORT:-8000}
SITE_NAME="flansa-mvp.local"

# CRITICAL: Work from frappe-bench directory
...
# Create site if needed using bench (the proper Frappe way)
if [ ! -d "sites/$SITE_NAME" ]; then
    echo "🏗️ Creating Frappe site with bench..."
...
# Use bench serve for production - this handles all the complexity
